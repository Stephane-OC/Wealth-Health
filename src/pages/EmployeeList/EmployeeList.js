...
export default function EmployeeList() {
  ...
  const [columnDefs] = useState([
    { field: "firstName", sortable: true, filter: true, minWidth: 100, maxWidth: 200 },
    { field: "lastName", sortable: true, filter: true, minWidth: 100, maxWidth: 200 },
    { field: "startDate", sortable: true, filter: true, minWidth: 100, maxWidth: 200 },
    { field: "department", sortable: true, filter: true, minWidth: 100, maxWidth: 200 },
    { field: "dateOfBirth", sortable: true, filter: true, minWidth: 100, maxWidth: 200 },
    { field: "street", sortable: true, filter: true, minWidth: 100, maxWidth: 200 },
    { field: "city", sortable: true, filter: true, minWidth: 100, maxWidth: 200 },
    { field: "state", sortable: true, filter: true, minWidth: 100, maxWidth: 200 },
    { field: "zipCode", sortable: true, filter: true, minWidth: 100, maxWidth: 200 },
  ]);
